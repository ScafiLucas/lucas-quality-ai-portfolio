...
from app.services.scoring.score_service import calculate_score
from app.services.status.status_service import get_job_status
from app.services.uploading.upload_service import process_csv_upload
...
def submit_score(data: ScoreInput, db: Session = Depends(get_db)):
    ...
    result = calculate_score(data, db)
    return result
